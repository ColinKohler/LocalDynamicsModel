...
ENV_CONFIGS = {
  'block_stacking_2' : BLOCK_STACKING_2_ENV_CONFIG,
  'block_stacking_2_deconstruct' : BLOCK_STACKING_2_ENV_CONFIG,
  'block_stacking_3' : BLOCK_STACKING_3_ENV_CONFIG,
  'block_stacking_3_deconstruct' : BLOCK_STACKING_3_ENV_CONFIG,
  'house_building_1' : HOUSE_BUILDING_1_ENV_CONFIG,
  'house_building_1_deconstruct' : HOUSE_BUILDING_1_ENV_CONFIG,
  'house_building_2' : HOUSE_BUILDING_2_ENV_CONFIG,
  'house_building_2_deconstruct' : HOUSE_BUILDING_2_ENV_CONFIG,
  'house_building_3' : HOUSE_BUILDING_3_ENV_CONFIG,
  'house_building_3_deconstruct' : HOUSE_BUILDING_3_ENV_CONFIG,
  'house_building_4' : HOUSE_BUILDING_4_ENV_CONFIG,
  'house_building_4_deconstruct' : HOUSE_BUILDING_4_ENV_CONFIG,
  'bottle_tray' : BOTTLE_TRAY_ENV_CONFIG,
  'box_palletizing' : BOX_PALLETIZING_ENV_CONFIG,
  'bin_packing' : BIN_PACKING_ENV_CONFIG,
}

ENV_TYPES = {
  'block_stacking_2' : 'block_stacking',
  'block_stacking_2_deconstruct' : 'block_stacking_deconstruct',
  'block_stacking_3' : 'block_stacking',
  'block_stacking_3_deconstruct' : 'block_stacking_deconstruct',
  'house_building_1' : 'house_building_1',
  'house_building_1_deconstruct' : 'house_building_1_deconstruct',
  'house_building_2' : 'house_building_2',
  'house_building_2_deconstruct' : 'house_building_2_deconstruct',
  'house_building_3' : 'house_building_3',
  'house_building_3_deconstruct' : 'house_building_3_deconstruct',
  'house_building_4' : 'house_building_4',
  'house_building_4_deconstruct' : 'house_building_4_deconstruct',
  'bottle_tray' : 'bottle_tray',
  'box_palletizing' : 'box_palletizing',
